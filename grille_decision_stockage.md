...
> **Compagnon de la [grille de décision C4](grille_decision_C4.md)** (qui, elle,
...
> **Règle d'or sobriété (cf. principes du parcours)** : le bon stockage est **le plus
...
*Grille pédagogique — Stockage & échelle. Version v1.1 par
