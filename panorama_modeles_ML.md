...
> [`grille_decision_C4.md`](./grille_decision_C4.md), enrichie collectivement.
>
...
brille selon le contexte (cf. `grille_decision_C4.md`).
...
> Tu retrouveras ce raisonnement dans la `grille_decision_C4.md`.
...
> la `grille_decision_C4.md` progressivement.
